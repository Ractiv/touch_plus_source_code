...
// require("nw.gui").Window.get().evalNWBin(null, process.cwd() + "/system/js/aws-credentials.bin");

var AwsAccessKeyID = "AKIAIN2LJVBOBANTUNPQ";
var AwsSecretAccessKey = "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";
var AwsBucketName = "ractivtest";
...
S3.prototype.ReadTextKey = function(keyName, callback, errorCallback)
{
	...
	{
		console.log(keyName + " " + progress.loaded + " of " + progress.total + " bytes");
	});
};
