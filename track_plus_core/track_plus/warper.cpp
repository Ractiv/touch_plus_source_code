...
void CWarper::setSource(float x0, float y0, float x1, float y1, float x2, float y2, float x3, float y3)
{
	srcX[0] = x0;
	srcY[0] = y0;
	srcX[1] = x1;
...
void CWarper::setDestination(float x0,	float y0, float x1, float y1, float x2,	float y2, float x3, float y3)
{
	dstX[0] = x0;
	dstY[0] = y0;
	dstX[1] = x1;
...
void CWarper::computeSquareToQuad(float x0, float y0, float x1, float y1, float x2,float y2, float x3, float y3, float mat[])
{
...
void CWarper::computeQuadToSquare(float x0, float y0,	float x1, float y1, float x2, float y2, float x3, float y3, float mat[])
{
...
void CWarper::multMats(float srcMat[], float dstMat[], float resMat[])
{
...
void CWarper::warp(float mat[], float srcX, float srcY, float &dstX, float &dstY)
{
	float result[4];
	float z = 0;
...
void CWarper::warp(float srcX, float srcY, float &dstX, float &dstY)
{
	if (dirty)
		computeWarp();
