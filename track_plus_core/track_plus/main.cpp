...
bool compute()
{
    ...
    if (proceed)
    {
        ...
        proceed1 = mono_processor1.compute_mono0(hand_splitter1, pose_estimator, "1", true);
        proceed0 = mono_processor0.compute_mono0(hand_splitter0, pose_estimator, "0", true);
        proceed = proceed0 && proceed1;
    }
